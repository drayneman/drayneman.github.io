...
class Navigator extends React.Component {
  ...
  collapseWithScroll() {
    ...
    else if (topDistance > 5 && this.state.paddingTop.localeCompare(".5rem")) {
  ...
  render() {
    ...
    // console.log(this.props.page !== undefined && !this.props.page.localeCompare('home'))

    return (
      <nav className={style.navigator}>
        <ul>
          {this.props.page !== undefined && !this.props.page.localeCompare('home') ? undefined : <li><Block color={COLORS.main} to="/" scrollAction={this.collapseWithScroll} paddingTop={paddingTop}>home</Block></li>}
